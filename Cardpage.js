...
export default class Cardpage extends React.Component {
    ...
    render(){
      if ("title" in this.state.staticData) {
        ...
        console.log(staticData.content);
        return(
            <Fragment>
                ...
                <ScrollView>
                    <View style={styles.wrapper}>
                        ...
                        <View>
                            ...
                            {activeCardContent &&
                            <View style={{ ...styles.cardWrapper, marginTop: (activeCardIndex >= 1) ? 15 : 25,  borderColor: (this.props.navigation.state.params.planName.toUpperCase() === "EMERGENCY RESPONSE PLAN" ? COLOR_CODES[activeCardContent.card_type].headColor : COLOR_CODES['end'].headColor)  }}>
                                <View style={{ ...styles.titleContainer, backgroundColor: (this.props.navigation.state.params.planName.toUpperCase() === "EMERGENCY RESPONSE PLAN" ? COLOR_CODES[activeCardContent.card_type].headColor : COLOR_CODES['end'].headColor) }}>
                                    <Text style={ styles.title}>
                                        {`${navigation.state.params.chartData.title}${isIncident ? ' - ' : ''}${isIncident ? activeCardContent.card_type : ''}`}
                                    </Text>
                                </View>
                                <View style={{ ...styles.cardBody, backgroundColor: (this.props.navigation.state.params.planName.toUpperCase() === "EMERGENCY RESPONSE PLAN" ? COLOR_CODES[activeCardContent.card_type].bgColor : COLOR_CODES['end'].bgColor) }}>
                                    <HTMLView
                                        value={(Base64.decode(activeCardContent.content)).replace(/^\s+|\s+$/g, '').replace(/(\r\n|\n|\r)/gm, "")}
                                        ...
                                        <View style={styles.btnWrapper}>
                                            {
                                                activeCardContent.actions.length ? activeCardContent.actions.map((item, idx) => (
                                                        <TouchableOpacity
                                                            ...
                                                            underlayColor='#fff'
                                                            style={{ ...styles.singleNxtBtn, backgroundColor: COLOR_CODES[activeCardContent.card_type].headColor }}
                                                        >
                                                    ...
                                                    : <Fragment>
                                                        ...
                                                        <TouchableOpacity
                                                            ...
                                                            underlayColor='#fff'
                                                            style={{ ...styles.nxtBtn, marginTop: 30, backgroundColor: COLOR_CODES[activeCardContent.card_type].headColor }}
                                                        >
                ...
                {(isIncident && this.props.navigation.state.params.planName.toUpperCase() === "EMERGENCY RESPONSE PLAN") &&
                    <Fragment>
                        <TouchableOpacity
                            style={{
                                position: 'absolute',
                            ...
                            <ScrollView>
                                    ...
                                    <HTMLView
                                        style={{
                                            ...
                                            paddingLeft: 20,
                                            paddingRight: 20, }}
                                        value={staticData.content.replace(/(\r\n|\n|\r)/gm, "")}
                                        stylesheet={{
                                            h3: {
